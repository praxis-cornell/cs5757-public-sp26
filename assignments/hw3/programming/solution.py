"""
Homework 3: Optimal Control — Student Solution File

Students: implement every function marked with `raise NotImplementedError()`.
...
def linearize(f: Callable, cost: Callable, s: jnp.ndarray, a: jnp.ndarray):
    ...
    Arguments: f:dynamics function, cost:cost function, s:state, a:control
    """
    # Problem 3.1(b) ##########################################################
